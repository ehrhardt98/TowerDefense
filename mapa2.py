...
def mapa():
	...
	terrenos = [CANTOESQUERDO, LADOESQ, GRASS,AGUA, LADODIR, CIMAGRAMA, BAIXOGRAMA,CANTODIREITO, CAMINHO, tilecastelo, bordatorre, cantotorre, bordabaixo, pedra, arvore, homens, casa, sangue, carro]
	...
	textures = {
		...
		homens: pygame.image.load('homens.png'),
